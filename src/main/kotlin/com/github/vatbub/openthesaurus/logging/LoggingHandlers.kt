...
package com.github.vatbub.openthesaurus.logging

import com.github.vatbub.openthesaurus.App
...
object LoggingHandlers {
    ...
    object TextFieldHandler : Handler() {
        ...
        var loggingTextFlow: TextFlow? by Delegates.observable<TextFlow?>(null) { _, _, newValue ->
            publishDelayedTextNodes(
                newTextFlow = newValue
            )
        }
        ...
        private fun publishDelayedTextNodes(
            newDelayLogUpdatesValue: Boolean = delayLogUpdates,
            newTextFlow: TextFlow? = loggingTextFlow
        ) = Platform.runLater {
            synchronized(Lock) {
